...
<div class="d-flex align-items-center justify-content-between mb-4 mt-2">
    ...
    <a href="{{ $fullUrl }}" target="_blank" class="btn btn-outline-secondary d-flex align-items-center gap-1.5 py-2 px-3.5 fw-semibold rounded-3 shadow-sm">
...
<div class="row g-4">
    ...
    <div class="col-md-7 col-lg-8">
        <div class="d-flex gap-2 mb-4">
            <button class="btn btn-secondary d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#editProfileModal">
                <span data-duo-icons="user"></span> Edit Profil
            </button>
